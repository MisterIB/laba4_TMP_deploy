...
type Functions<Type> = {
    [Key in keyof Type]-?: Type[Key] extends Function ? Key : Type[Key] extends object ? Functions<Type[Key]> : never;
}[keyof Type];
 ...
 */
export declare const callUserfront: ({ method, args }: CallUserfront) => Promise<any>;
/**
 ...
 */
export declare const callUserfrontSync: ({ method, args }: CallUserfront) => any;
export {};
