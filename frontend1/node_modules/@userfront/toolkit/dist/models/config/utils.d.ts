...
export declare const createOnlyFactorCondition: ({ channel, strategy, secondFactor, }: any) => (context: any) => boolean;
...
export declare const getTargetForFactor: (factor: Factor) => "" | "password" | "totp" | "emailLink" | "emailCode" | "smsCode" | "ssoProvider";
