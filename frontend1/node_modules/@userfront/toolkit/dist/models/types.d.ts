...
export type View = EmailLink | EmailCode | SmsCode | Password | TotpCode | ResetPassword | FirstFactors | SecondFactors | Message | Loading;
export type Query = {
    token?: string;
    uuid?: string;
    linkType?: string;
...
export type AuthMachineEvent = BackEvent | FinishEvent | ResendEvent | RetryEvent | UserfrontApiDoneEvent | UserfrontApiErrorEvent | EmailSubmitEvent | CodeSubmitEvent | PasswordSubmitEvent | PhoneNumberSubmitEvent | TotpCodeSubmitEvent | UseBackupCodeEvent | SelectFactorEvent | SetNewPasswordSubmitEvent;
export type AuthMachineConfig = MachineConfig<AuthContext<View>, any, AuthMachineEvent>;
